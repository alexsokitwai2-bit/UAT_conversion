...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React3 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState3 = React3.useState, useEffect11 = React3.useEffect, useLayoutEffect2 = React3.useLayoutEffect, useDebugValue = React3.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var TreeApi = class _TreeApi {
  ...
  selectContiguous(identity) {
    ...
    if ((_a = this.get(id)) === null || _a === void 0 ? void 0 : _a.isSelectable) {
      ...
      const selectableNodes = this.filterSelectableNodes(this.nodesBetween(anchor, identifyNull2(id)));
      this.dispatch(actions2.remove(this.nodesBetween(anchor, mostRecent)));
      this.dispatch(actions2.add(selectableNodes));
  ...
  filterSelectableNodes(nodes) {
    return nodes.map((n) => this.get(identify2(n))).filter((n) => !!n && n.isSelectable);
  }
  setSelection(args) {
    var _a;
